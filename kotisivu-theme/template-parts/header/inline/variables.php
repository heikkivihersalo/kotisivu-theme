...
html {
    ...
    --spacing-xxs: <?php echo get_theme_mod('spacing_xs', 'clamp(1rem, calc(0.75rem + 1.25vw), 2.25rem)');?>;
    ...
    --clr-grey: hsl(var(--brand-hue), 2%, 40%);
    --clr-highlight: hsl(var(--brand-hue), var(--brand-saturation), 30%);

    /* Black & Whites */
    --clr-lightest: hsl(var(--brand-hue), 2%, 98%);
